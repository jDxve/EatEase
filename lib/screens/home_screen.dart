  ...
  Future<void> fetchRestaurants() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        List<Map<String, dynamic>> parsedRestaurants = data.map((item) {
          try {
            ...
            return {
              ...
              'dbStatus':
                  item['status'], // Store the original status for filtering
            };
          } catch (e) {
        ...
        // Filter out restaurants with status other than 1
        parsedRestaurants = parsedRestaurants.where((restaurant) {
          return restaurant['dbStatus'] ==
              1; // Only keep restaurants with status 1
        }).toList();

        setState(() {
          restaurants = parsedRestaurants;
          filteredRestaurants = parsedRestaurants; // Initialize filtered list
        });
      } else {
                ...
                child: RefreshIndicator(
                  ...
                  child: filteredRestaurants.isEmpty
                    ...
                    child: Text(
                      ...
                      : ListView.builder(
                    padding: EdgeInsets.zero, // Ensures no padding at the top
